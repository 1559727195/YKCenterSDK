...
public final class XPGWifiErrorCode {
   ...
   public static final int XPGWifiError_SDK_INIT_FAILED = -60;
   public static final int XPGWifiError_DEVICE_IS_INVALID = -61;
   public static final int XPGWifiError_GROUP_IS_INVALID = -62;
